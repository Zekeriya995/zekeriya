...
var reportHistory=JSON.parse(localStorage.getItem('nxRptHist')||'[]');
var prevReport=JSON.parse(localStorage.getItem('nxPrevRpt')||'null');
var hourlyLog=JSON.parse(localStorage.getItem('nxHrLog')||'[]');
