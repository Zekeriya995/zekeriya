     ...
     because they're loaded as plain, non-module <script> tags) */
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        gemEntryGate: 'readonly',
        isLikelyStablecoin: 'readonly',
        ...
        classifyFreshness: 'readonly',
        scalpVerdictAllowsEntry: 'readonly',
        autoMinScore: 'readonly',
        scanPresetFloor: 'readonly',
        scalpDailyPlan: 'readonly',
        fallingKnifePenalty: 'readonly',
        gemMcGate: 'readonly',
        ...
        lastWsDataTime: 'writable',
        lastRestDataTime: 'writable',
        timeBadge: 'readonly',
