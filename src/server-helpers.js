...
const FETCH_HOST_ALLOWLIST = new Set([
  ...
  /* Multi-exchange enrichment sources used by app.js (Bitfinex margin
     pos.size, Hyperliquid funding+OI, CoinTelegraph RSS for news).
     All three are public read-only endpoints — they don't accept
     credentials so the user-info-smuggling guard further down is the
